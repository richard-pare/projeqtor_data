select project.name as "Project name",activity.name as "Activity name", resource.fullName as "Resource name",role.name as "Function", plannedwork.week,sum(plannedwork.work) as "Sum of planned work"
from plannedwork 
