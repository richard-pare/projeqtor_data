select project.name as "Project name",activity.name as "Activity name", resource.fullName as "Resource name",role.name as "Function", work,week,sum(work.work) as "Sum of work",sum(work.cost) as "Sum of cost"
from work 
